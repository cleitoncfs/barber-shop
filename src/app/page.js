...
import WhatsAppButton from "./WhatsAppButton"; // Importando o botão flutuante
...
export default function Page() {
    ...
    return (
        <>
            <div
                className={
                    ehTemaEscuro ? estilos.modo_escuro : estilos.modo_claro
                }
            >
                    ...
                    <section className={estilos.secao_texto}>
                        <div>
                            ...
                            <p>
                                ...
                                impecáveis, mas uma experiência de cuidado e
                                estilo.
                            </p>
                            <p>
                                Nossa equipe de profissionais altamente
                                qualificados está sempre pronta para superar
                                suas expectativas e garantir que você saia daqui
                                se sentindo sua melhor versão.
                            </p>
                            <p>
                                Cada serviço que oferecemos é pensado para
                                valorizar sua personalidade e fortalecer sua
                                confiança, porque acreditamos que um bom corte
                                de cabelo faz toda a diferença.
                            </p>
                            <p>
                ...
                <footer className={estilos.footer}>
                    <p className={estilos.footerCopyright}>
                        © {new Date().getFullYear()} Barber Shop - Todos os
                        direitos reservados
                    </p>
